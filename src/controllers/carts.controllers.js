...
export const agregarProductoAlCarrito = async (req, res) => {
  try {
    // Lógica para agregar un producto al carrito utilizando cartDao
    ...
    // Personalizar el mensaje de error utilizando el servicio de errores
    const errorCode = 'OUT_OF_STOCK'; // Puedes ajustar el código según el tipo de error
    res.status(500).json({ error: customizeError(errorCode, error.message) });
  }
};
